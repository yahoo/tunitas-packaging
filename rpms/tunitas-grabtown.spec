...
%description
Tunitas Grabtown is the DataX Compiler and Validator.  The package
contains runtime components for validating the on-the-wire transfer
format and and for compiling the transfer format into a database.
JSON and SQLite are the supported format and database, respectively.

%package devel
Summary: The development components of Tunitas Grabtown
